  ...
  return (
    ...
    {loading == true ? (<Loading containerStyle={{ marginTop: 200 }} />) :
      <div style={{marginTop:90, padding:10}}>
        ...
        <div style={{textAlign:"left"}}>홍여사 가이드 문서입니다</div>
        <div style={{textAlign:"left"}}>내용위주로 가이드 템플릿이  나왔으면 좋겠습니다</div>


        <div style={{textAlign:"left", marginTop:30}}>다음은 참고할만한 가이드 샘플 이미지입니다
          각각의 가이드 에대한 핵심 내용을 기술 할수 있도록 되어 있고 상세 내용은 아래에 기술 되어 있습니다
          또한 가이드에 대한 이미지를 봐야 하는 경우 별도의 버튼을 만들어서 볼수 있도록 되어 있습니다
          아래의 리뷰 이벤트 예시처럼
        </div>

        <img src={imageDB.guidesample} style={{width:"100%", background:'#fff'}}/>
