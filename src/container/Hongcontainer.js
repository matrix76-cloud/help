    ...
    {loading == true ? (<Loading containerStyle={{ marginTop: 200 }}
     />) :
      <div style={{marginTop:50}}>
          <Congratulation>
            <div  style={{padding: "5px 10px", background:"#fff", width:"150px",borderRadius: "20px", color:'#000'}} onClick={_handleladyinfo}>믿고 맡길수 있는 홍여사</div>
          
          </Congratulation>
          <div style={{height:360,width:"100%",backgroundColor:'#ff4e19'}}>

            <HelpCheck>홍여사를 이용하면 좋은 효과등을 표현 해줄수 있는, 누구나 홍여사가 될수 있음을 표현
            디자인상 불필요 하다고 하면 메인 화면에 배너 만 유지하고 이곳은 없애도 무방 합니다(선택)
            </HelpCheck>

          </div>
          {/* <img src={imageDB.banner1} style={{width:"100%", height:160}}/> */}
          <Stickposition top={0}>
