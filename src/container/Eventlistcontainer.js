  ...
  return (
    ...
    {loading == true ? (<Loading containerStyle={{ marginTop: 200 }} />) :
      <div style={{marginTop:90}}>
        ...
        <div style={{textAlign:"left"}}>타임룰렛, 출석체크, 8월한달간 가입한 신규회원 이벤트, 친구추가, 이달의 활동왕 총 다섯개의 이벤트가 필요합니다</div>


        <div style={{display:"flex", flexDirection:"column", marginTop:70}}>
            <div style={{textAlign:"left"}}>매일매일 언제 나타날지 모르는 타임룰렛 이벤트 </div>
            <div style={{textAlign:"left",marginBottom:10}}>유효기간: 계속 </div>
            <img src={imageDB.event1} style={{width:"100%"}}/>
        </div>

        <div style={{display:"flex", flexDirection:"column",marginTop:30}}>
            <div style={{textAlign:"left"}}>출석하고 포인트 왕창 받자 이벤트 </div>
            <div style={{textAlign:"left",marginBottom:10}}>유효기간: 2024.7월 한달간 </div>
            <img src={imageDB.event2} style={{width:"100%"}}/>
        </div>

        <div style={{display:"flex", flexDirection:"column",marginTop:30}}>
            <div style={{textAlign:"left"}}>친구 추가 하고 선물받자 </div>
            <div style={{textAlign:"left",marginBottom:10}}>유효기간: 2024년 7월 1일 ~ 2024년 9월 31일 </div>
            <img src={imageDB.event3} style={{width:"100%"}}/>
        </div>
