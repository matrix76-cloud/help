...
const Historylistcontainer = ({role}) => {
  ...
  return (
    ...
    {loading == true ? (<Loading containerStyle={{ marginTop: 200 }} />) :
      <div style={{marginTop:90, padding:10}}>
        ...
        <div style={{textAlign:"left",marginBottom:20}}>테이블 형식으로 나왓으면 좋겠습니다. 약간 공식적인 문서 느낌
          결재 내역 관리 입금 내역 관리 모두 공통입니다
        </div>
...
export default React.memo(Historylistcontainer);
