...
export default function ReviewupdateModalEx({callback, data}) {
      ...
      >
        <Fade in={open}>
          <Box sx={style}>
              ...
              <Label content={'댓글수정'} containerStyle={{marginTop:-30}}/>
            <MainData>
            <textarea type="text"
                style={{
              fontSize: 14, width: "80%", height: 80,
              margin: "0px 5%",
              padding: 10,
              fontSize: '12px',
              ...
              onChange = {e => {
                ...
                {/* <input type="text" style={{border:"none", fontSize:14}} value={reviewcontent}/> */}
            </MainData>
      
            <ApplyItem >
                <div style={{dispaly:"flex", alignItems:"flex-end", marginRight :35, justifyContent:"center"}}>   
                    <FilterApplyButton onClick ={_handlereviewupdate}><FilterApplyButtonText>적용</FilterApplyButtonText></FilterApplyButton>
                </div>
            </ApplyItem>
          </Box>
        </Fade>
