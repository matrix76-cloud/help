...
const Premiumshop = ({ containerStyle, shopdata, simple }) => {
  ...
  //   const FindIndex = user.premiumshoplist.findIndex(x=>x.STORE_ID  == storedata.STORE_ID);

  //   if(FindIndex != -1){

  //     setStoredata(user.premiumshoplist[FindIndex]);
  ...
  useEffect(() => {
    ...
    const lat2 = shopdata.STORELATITUDE;
    const lon2 = shopdata.STORELONGITUDE;
      ...
      <ProductContentView>
        ...
        <ProductInfoView>
          ...
          <ProductHeartview onClick={_handleHeart}>
            ...
            >
              {ArrayIncludeData(heartuser, user.uid) == true ? (
                <Image
