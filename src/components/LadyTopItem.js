...
const LadyTopItem = ({ containerStyle,NO, USER_IMG,USER_NICKNAME,ADDR,SCORE1, SCORE2,SCORE3, SCORE4, bgcolor}) => {
  ...
  return (
    <Container style={containerStyle} className={NO == 1 ? "" : "box2" }>
            ...
            <ReviewPersonItem>
              ...
              <div style={{display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"center"}}>
                ...
                <div style={{color: "#999",fontSize: "12px"}}>
                  <div>{NO}위</div>
                  <img src={imageDB.medal} style={{width:"25px"}}/>
                </div>
                <Pictureline>
                <Image
                  source={USER_IMG}
              ...
              <ActivityView onClick={_handleprofile}>
                프로필보기
              </ActivityView>
            </ReviewPersonItem>
