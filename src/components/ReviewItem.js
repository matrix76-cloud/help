...
const ReviewItem = ({ containerStyle,USER_IMG,USER_NICKNAME,REGISTDATE,CONTENTS,WRITER,STAR }) => {
    ...
    <Container style={containerStyle} >
      <ReviewDetailItem>
            ...
            <div style={{marginTop:5}}>
              <ReactStars count={STAR} value={5} size={24} color1={'#ffd700'}  color2={'#ffd700'}/>
            </div>
