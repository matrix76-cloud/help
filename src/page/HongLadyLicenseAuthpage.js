...
import HongLadyLicenseAuthcontainer from "../container/HongLadyLicenseAuthcontainer";


const HongLadyLicenseAuthpage = () => {
  ...
  return (
    <PrevLayout
      ...
      header={true}
      headerdetail={true}
      headername={"홍여사 인증 2/2단계"}
    >
      <HongLadyLicenseAuthcontainer role={role}/>
    </PrevLayout>
  );
};

export default HongLadyLicenseAuthpage;
