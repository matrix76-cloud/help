...
import MyStoreordercontainer from '../container/Mystoreordercontainer';
...
const Mystoreorderpage = ({containerStyle}) => {

  const {state} = useLocation();


  return (
    <PrevLayout menu ={false} bottom ={false} header={true} headername={'입점문의'}>
      <MyStoreordercontainer  STORE={state.STORE} />
    </PrevLayout>
  );
}

export default Mystoreorderpage;
