...
import HongLadyInfocontainer from "../container/HongLadyInfocontainer";
import HongLadyProfilecontainer from "../container/HongLadyProfilecontainer";

const HongLadyProfilepage = () => {
  ...
  return (
    <PrevLayout
      ...
      header={true}
      headerdetail={true}
      headername={"이순자 홍여사님 프로필 정보"}
    >
      <HongLadyProfilecontainer />
    </PrevLayout>
  );
};

export default HongLadyProfilepage;
