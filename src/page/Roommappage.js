...
import Roommapcontainer from "../container/Roommapcontainer";
...
const Roommappage = () => {
  ...
  return (
    <RoomLayout callback={switchrole} menu={true} bottom={false} header={true} headerdetail={false}>
      <Roommapcontainer role={role}/>
    </RoomLayout>
  );
};
