...
import Hongmapcontainer from "../container/Hongmapcontainer";
import HongmapLayout from "../screen/Layout/HongmapLayout";
...
const Hongmappage = () => {
  ...
  return (
    <HongmapLayout callback={switchrole} menu={true} bottom={false} header={true} headerdetail={false}>
      <Hongmapcontainer role={role}/>
    </HongmapLayout>
  );
};

export default Hongmappage;
